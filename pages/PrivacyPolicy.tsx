        ...
        <div className="container mx-auto px-6 max-w-4xl">
          <div className="prose prose-lg prose-slate dark:prose-invert max-w-none">
            ...
            <p className="text-slate-500 dark:text-slate-400 mb-8 leading-relaxed">
              Welcome to JXING Tech ("Company", "we", "our", "us"). We operate the website jxing.tech (the "Service"). 
              Our Privacy Policy governs your visit to jxing.tech, and explains how we collect, safeguard and disclose information that results from your use of our Service.
            </p>
            ...
            <p className="text-slate-500 dark:text-slate-400 mb-8 leading-relaxed">
              If you have any questions about this Privacy Policy, please contact us by email: <strong>hello@jxing.tech</strong>.
            </p>
          </div>
        </div>
      </section>
