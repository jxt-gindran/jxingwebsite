           ...
           <div className="lg:col-span-4 grid grid-cols-1 gap-6">
              ...
              <div className="hover-box bg-transparent border border-brand-oxford/10 dark:border-white/10 p-10 rounded-3xl h-full flex flex-col justify-center hover:border-brand-vermilion dark:hover:border-brand-vermilion group transition-all duration-300">
                 <div className="flex items-center gap-2 mb-4">
                    ...
                    <span className="text-sm font-medium text-slate-500 dark:text-slate-400 group-hover:text-brand-vermilion transition-colors">{t('stats.projects')}</span>
                 </div>
                 <div className="mb-4">
              ...
              <div className="hover-box bg-transparent border border-brand-oxford/10 dark:border-white/10 p-10 rounded-3xl h-full flex flex-col justify-center hover:border-brand-vermilion dark:hover:border-brand-vermilion group transition-all duration-300">
                 <div className="flex items-center gap-2 mb-4">
                    <span className="w-2 h-2 rounded-sm bg-brand-azure animate-pulse-gentle"></span>
                    <span className="text-sm font-medium text-slate-500 dark:text-slate-400 group-hover:text-brand-vermilion transition-colors">{t('stats.retention')}</span>
                 </div>
                 <div className="mb-4">
                    <div className="text-6xl font-bold text-brand-oxford dark:text-white">
               ...
               <div className="hover-box bg-transparent border border-brand-oxford/10 dark:border-white/10 p-10 rounded-3xl h-full flex flex-col justify-center hover:border-brand-vermilion dark:hover:border-brand-vermilion group transition-all duration-300">
                 <div className="flex items-center gap-2 mb-4">
                    <span className="w-2 h-2 rounded-sm bg-brand-azure animate-pulse-gentle"></span>
                    <span className="text-sm font-medium text-slate-500 dark:text-slate-400 group-hover:text-brand-vermilion transition-colors">{t('stats.hours')}</span>
                 </div>
                 <div className="mb-4">
                    <div className="text-6xl font-bold text-brand-oxford dark:text-white">
