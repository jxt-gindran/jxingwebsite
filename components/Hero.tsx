...
export const Hero: React.FC = () => {
  ...
  return (
    <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 bg-brand-ghost dark:bg-brand-oxford transition-colors duration-300 z-0">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="relative max-w-6xl mx-auto mt-12 z-20">
          <div className="hover-box rounded-3xl overflow-hidden shadow-2xl shadow-brand-oxford/5 dark:shadow-none relative group bg-brand-timberwolf dark:bg-slate-800 border border-brand-oxford/10 dark:border-white/10">
            ...
            {/* Floating Badge */}
            <div className="absolute bottom-12 left-12 rtl:left-auto rtl:right-12 hidden md:flex items-center gap-3 bg-white/90 dark:bg-brand-oxford/90 backdrop-blur-md p-2 pr-6 rtl:pr-2 rtl:pl-6 rounded-2xl border border-brand-oxford/10 dark:border-white/10 shadow-lg animate-fade-in-up">
              <div className="flex -space-x-3 rtl:space-x-reverse">
                 <img src="https://images.unsplash.com/photo-1580489944761-15a19d654956?auto=format&fit=crop&w=100&h=100" className="w-10 h-10 rounded-lg border-2 border-white dark:border-brand-oxford object-cover" alt="user" />
                 <img src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=100&h=100" className="w-10 h-10 rounded-lg border-2 border-white dark:border-brand-oxford object-cover" alt="user" />
                 <img src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=100&h=100" className="w-10 h-10 rounded-lg border-2 border-white dark:border-brand-oxford object-cover" alt="user" />
              </div>
              <div>
                <p className="text-brand-oxford dark:text-white font-bold leading-none">
                  <CountUp end={180} suffix="+" />
                </p>
                <p className="text-xs text-slate-500 dark:text-slate-400 font-medium font-light">{t('hero.satisfied_customers')}</p>
              </div>
            </div>
          </div>
        </div>
